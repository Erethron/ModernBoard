...
namespace ChessVM
{
	...
	public class PositionViewModel
	{
		...
		public MoveViewModel NextMove => Position.NextMove == null ? null : new MoveViewModel(Position.NextMove);

		public PositionViewModel(GamePosition position, GameMove lastMove = null)
		{
			LastMove = lastMove;
		...
		{
			return new PositionViewModel(Position.RemovePiece(coordinate));
		}

		internal PositionViewModel SetMove(GameMove move)
		{
			Position.SetMove(move.Move);
			return new PositionViewModel(Position.NextMove.NextPosition, move);
		}
